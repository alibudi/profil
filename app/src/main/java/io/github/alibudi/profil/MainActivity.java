package io.github.alibudi.profil;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            //intent teleponn
            Intent telfon  = new  Intent(Intent.ACTION_DIAL, Uri.parse("tel:082326736070"));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            share.putExtra(Intent.EXTRA_TEXT, " Halo temen-temen ada aplikasi bagus");
            startActivity(Intent.createChooser(share, "Share to friends"));

        } else if (id == R.id.nav_send) {
            Intent sms = new Intent(Intent.ACTION_SENDTO, Uri.parse("smsto:082326736070"));
            sms.putExtra("sms body", "halooo gaess");
            startActivity(sms);
        }
